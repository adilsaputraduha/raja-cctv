                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="hidden" value="<?= $row['pemesanan_pelanggan']; ?>" id="idpelanggan" name="idpelanggan" class="idpelanggan">
                                <input type="text" id="namapelanggan" value="<?= $row['pelanggan_nama']; ?>" name="namapelanggan" required readonly class="form-control namapelanggan" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" value="<?= $row['pemesanan_tanggal']; ?>" class="form-control tanggalpemesanan" id="tanggalpemesanan" name="tanggalpemesanan" required placeholder="Masukan tanggalpemesanan">
                            <div class="invalid-feedback">
            ...
            foreach ($pemesanan as $row) : ?>
                <div class="row justify-content-end">
                    <div class="col-lg-3">
                        ...
                        <input type="text" value="1" readonly class="form-control totalitem"></input>
                    </div>
                </div>
                <br>
                <div class="row justify-content-end">
